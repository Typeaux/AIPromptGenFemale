...
categories = {
    "Occupation": ["Athlete", "Nun", "Priest", "Shaman", "Cheerleader", "Mechanical Engineer", "Space Explorer", "Gamer", "Scientist", "Librarian", "Artist", "Mecha Pilot", "Bounty Hunter", "Trail Guide", "Surgeon", "Interstellar Trader", "Banker", "Anti-Gravity Architect", "Holovid Producer", "Astrobiologist", "Terraforming Specialist", "Mystic Oracle", "Potion Master", "Dragon Trainer", "Spell Weaver", "Knight-Errant", "Court Magician", "Treasure Hunter", "Beastmaster", "Guild Leader", "Diplomat to the Fae", "Sorceress", "Sky Pirate", "Necromancer", "Wizard", "Wandering Minstrel", "Elemental Shaman", "Shadow Assassin"],
